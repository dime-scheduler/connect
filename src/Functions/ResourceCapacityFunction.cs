...
namespace Dime.Scheduler.Connect
{
    public class ResourceCapacityFunction : ImportService<ResourceCapacity>
    {
        ...
        [OpenApiOperation(operationId: Functions.ResourceCapacity, tags: new[] { Tags.Resource }, Description = Description, Summary = Summary)]
        [OpenApiRequestBody(OpenApiAttributeValues.BodyJson, typeof(ResourceCapacity), Description = OpenApiAttributeValues.BodyDescription, Required = true)]
