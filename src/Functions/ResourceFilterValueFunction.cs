...
namespace Dime.Scheduler.Connect
{
    public class ResourceFilterValueFunction : ImportService<ResourceFilterValue>
    {
        ...
        [OpenApiOperation(operationId: Functions.ResourceFilterValue, tags: new[] { Tags.Resource, Tags.Filter }, Description = Description, Summary = Summary)]
        [OpenApiRequestBody(OpenApiAttributeValues.BodyJson, typeof(ResourceFilterValue), Description = OpenApiAttributeValues.BodyDescription, Required = true)]
