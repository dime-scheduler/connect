...
namespace Dime.Scheduler.Connect
{
    public class ResourceCertificateFunction : ImportService<ResourceCertificate>
    {
        ...
        [OpenApiOperation(operationId: Functions.ResourceCertificate, tags: new[] { Tags.Resource }, Description = Description, Summary = Summary)]
        [OpenApiRequestBody(OpenApiAttributeValues.BodyJson, typeof(ResourceCertificate), Description = OpenApiAttributeValues.BodyDescription, Required = true)]
