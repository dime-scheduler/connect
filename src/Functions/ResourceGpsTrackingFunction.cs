...
{
    public class ResourceGpsTrackingFunction : ImportService<ResourceGpsTracking>
    {
        ...
        private const string Summary = "Resource Location";

        [FunctionName(Functions.ResourceGpsTracking)]
        [OpenApiOperation(operationId: Functions.ResourceGpsTracking, tags: new[] { OpenApiAttributeValues.OperationTags }, Description = Description, Summary = Summary)]
        [OpenApiRequestBody(OpenApiAttributeValues.BodyJson, typeof(ResourceGpsTracking), Description = OpenApiAttributeValues.BodyDescription, Required = true)]
