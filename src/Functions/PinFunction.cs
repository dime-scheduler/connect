...
namespace Dime.Scheduler.Connect
{
    public class PinFunction : ImportService<Pin>
    {
        ...
        [OpenApiOperation(operationId: Functions.Pin, tags: new[] { OpenApiAttributeValues.OperationTags })]        
        [OpenApiRequestBody(OpenApiAttributeValues.BodyJson, typeof(Pin), Description = OpenApiAttributeValues.BodyDescription)]
